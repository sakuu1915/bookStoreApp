...
function Navbar() {
  ...
  return (
    <>
      <div 
          className={` max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50 bg-white dark:bg-slate-900 text-black dark:text-white transition-all duration-300 ${
        sticky
          ? "sticky-navbar shadow-md bg-base-200 duration-300 transition-all ease-in-out"
          :""
      }`}
      >
  <div className="navbar bg-white dark:bg-slate-900 shadow-sm">
